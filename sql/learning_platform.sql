...
CREATE TABLE "answer" (
  ...
  "assessment" int,
  "feedback" varchar,
  PRIMARY KEY ("task_id", "user_id", "assignment_id")
);
...
ALTER TABLE "answer" ADD FOREIGN KEY ("task_id") REFERENCES "task" ("id") ON DELETE CASCADE;

ALTER TABLE "answer" ADD FOREIGN KEY ("user_id") REFERENCES "user" ("id") ON DELETE CASCADE;

ALTER TABLE "answer" ADD FOREIGN KEY ("assignment_id") REFERENCES "assignment" ("id") ON DELETE CASCADE;